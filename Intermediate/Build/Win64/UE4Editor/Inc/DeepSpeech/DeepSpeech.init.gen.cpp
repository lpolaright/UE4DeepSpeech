...
void EmptyLinkFunctionForGeneratedCodeDeepSpeech_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DeepSpeech()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_USparseDelegateFunction_DeepSpeech_SpeechRecognizedSignature__DelegateSignature,
			};
